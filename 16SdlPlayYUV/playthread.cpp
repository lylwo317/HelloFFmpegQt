...
#define IMG_W 1280
#define IMG_H 720
#define FILE_NAME "/home/kevin/Videos/sync.yuv"
...
//            SDL_WINDOW_SHOWN);
    ...
    while(file.read(data, imgSize) > 0 && !isInterruptionRequested()){
        END(SDL_UpdateTexture(texture, nullptr, data, IMG_W), SDL_UpdateTexture);
